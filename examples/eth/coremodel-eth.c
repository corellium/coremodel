...
static void test_eth_rxrdy(void *priv)
{
    /*
     * This function is called when the core exhausted its RX credits and later
     * the remote server returned some, so you may attempt to retransmit here
     */
